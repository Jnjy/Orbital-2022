import { Badge, Box, Container, Grid, Item, Paper, Stack, Typography } from '@mui/material'
...
function UserInformation() {
  ...
  const handleChange = (event, newValue) => {
    ...
    return (
        <Grid item md={4}>
            <Paper elevation={3}>
                <Grid container direction="column" spacing={2} className={styles.informationGrid}>
                    <Grid item>
                        <Badge
                            overlap="circular"
                            anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
                            badgeContent={
                            <Avatar alt="Remy Sharp" src="https://play-lh.googleusercontent.com/GkhngtFrSb3G9WXkWxJ9IRppbGVbNy7b_xyqa12Xa-Y3My_SXtsLamI5kR6or5zWGA" onClick={() => console.log("clicked")}/>
                            }
                        >
                            <Avatar 
                            alt="Profile Picture" 
